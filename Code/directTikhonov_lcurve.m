...
%
%INPUTS:
%   FieldMap(double matrix) - Field map in ppm
%   Mask(logical matrix) - Binary tissue mask
%   Parameters(struct): Parameters.Alpha(double) - Enter a single value of alpha or a range of alpha for l-curve optimisation. Default scans alpha from 10E-5 to 1 
%                       Parameters.Resolution(double vector) - Image resolution vector [dx dy dz] in mm
%                       Parameters.Orientation(double vector) - 3-element
%                       vector of the B0 direction (default: [0 0 1])
